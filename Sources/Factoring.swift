...
extension UnsignedInteger {
  ...
  public static func gcd(_ a: Self, _ b: Self) -> Self {
    ...
    if a == (0 as Self) { return b } // gcd(0, b) == b
    if b == (0 as Self) { return a } // gcd(a, 0) == a

    var a = a, b = b, shift = 0 as Self
    while ((a | b) & 1) == (0 as Self) {
      a &>>= 1
      b &>>= 1
      shift += 1
    }
    ...
    // dividing a and b.
    while (a & 1) == (0 as Self) { a &>>= 1 } // Now, a is odd.
    repeat {
      while (b & 1) == (0 as Self) { b &>>= 1 } // Now, b is odd.
  ...
  public static func lcm(_ a: Self, _ b: Self) -> Self {
    if a == (0 as Self) || b == (0 as Self) { return 0 }
    return a / .gcd(a, b) * b
  }
}
...
extension UnsignedInteger where Self : FixedWidthInteger {
  ...
  public static func lcmReportingOverflow(_ a: Self, _ b: Self)
    ...
    if a == (0 as Self) || b == (0 as Self) {
      return (partialValue: 0, overflow: .none)
    }
  ...
  public static func lcmFullWidth(_ a: Self, _ b: Self)
    ...
    if a == (0 as Self) || b == (0 as Self) { return (0, 0) }
...
where Self : FixedWidthInteger, Magnitude : FixedWidthInteger & UnsignedInteger,
  ...
  public static func gcdReportingOverflow(_ a: Self, _ b: Self)
    ...
    return (
      partialValue: t,
      overflow: ArithmeticOverflow(t < (0 as Self))
    )
  }
  ...
  public static func lcmReportingOverflow(_ a: Self, _ b: Self)
    ...
    return (
      partialValue: u,
      overflow: ArithmeticOverflow(overflow == .overflow || u < (0 as Self))
    )
  }
